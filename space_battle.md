...
Type: Workshop/Mega-lab/Mini-project<br>
...
## README.md and repos and github 

In previous labs, the instructions have been included in a repository's top-level README.md file. That's because, on github, that's the page that loads by default when you go to a repo's top level directory. Notice that this lab's assignment text is in a file that is NOT named README.md. **For this lab, you will not fork or clone. You will just create your own new repo for the project with a README.md to talk about it.** You should start with a preliminary description of what you're doing (like items 1-3 and 8 below). Then as you are building out your game and doing commits, you will naturally arrive at the other items.  Before you get to a basic working beta of your app, you should have all of these items finished.

In general github projects will be software that you are building. Hence a readme is in order explaining the project.  The following is not an exhaustive list, but a good starting point:
